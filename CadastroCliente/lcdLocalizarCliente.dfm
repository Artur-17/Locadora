object LocalizarCliente: TLocalizarCliente
  ...
  object grid: TcxGrid
    ...
    object gridTbv: TcxGridDBTableView
      ...
      object gridTbvNOME: TcxGridDBColumn
        DataBinding.FieldName = 'NOME'
      end
      object gridTbvCPF: TcxGridDBColumn
        DataBinding.FieldName = 'CPF'
      end
      object gridTbvEMAIL: TcxGridDBColumn
        DataBinding.FieldName = 'EMAIL'
      end
      object gridTbvTELEFONE: TcxGridDBColumn
        DataBinding.FieldName = 'TELEFONE'
      end
      object gridTbvDT_NASCIMENTO: TcxGridDBColumn
        DataBinding.FieldName = 'DT_NASCIMENTO'
      end
      object gridTbvESTADO: TcxGridDBColumn
        DataBinding.FieldName = 'ESTADO'
      end
      object gridTbvLOGRADOURO: TcxGridDBColumn
        DataBinding.FieldName = 'LOGRADOURO'
      end
      object gridTbvBAIRRO: TcxGridDBColumn
        DataBinding.FieldName = 'BAIRRO'
      end
      object gridTbvCIDADE: TcxGridDBColumn
        DataBinding.FieldName = 'CIDADE'
      end
      object gridTbvCOMPLEMENTO: TcxGridDBColumn
        DataBinding.FieldName = 'COMPLEMENTO'
      end
      object gridTbvOBSERVACAO: TcxGridDBColumn
